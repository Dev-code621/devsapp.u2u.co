@extends('frontend.layouts.device_template',['menu'=>"playlists","title"=>$title,"keyword"=>$keyword,"description"=>$description])
@section('content')
    <div id="playlist-table">
        ...
        <table class="table">
            ...
            @foreach($playlist->urls as $url)
                <tr>
                    <td class="text-center">{{$url->name}}</td>
                    <td class="text-center">{{$url->is_protected==1 ? 'This playlist is protected' : $url->url}}</td>
                    <td class="text-center">
                        <button class="playlist-action-btn-wrapper btn btn-outline-dark playlist-url-edit" data-current_id="{{$url->id}}" data-protected="{{$url->is_protected}}">
                            <i class="fa fa-edit playlist-icon"></i>
                            <span class="playlist-action-btn-txt">Edit</span>
                        </button>
                        <button class="playlist-action-btn-wrapper btn btn-outline-dark playlist-url-delete" data-current_id="{{$url->id}}" data-protected="{{$url->is_protected}}">
        ...
        <div id="device-page-loading-overlay">
            <img src="{{asset('images/WaitLoaderBlue.gif')}}">
        </div>
    </div>
    <div>
        <script>
